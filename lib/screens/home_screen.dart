...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void setupBatteryAnimation() {
    ...
    _animationBattery =
        CurvedAnimation(parent: _batteryController, curve: Interval(0, 0.5));

    _animationStatus =
        CurvedAnimation(parent: _batteryController, curve: Interval(0.6, 1));
  }
          ...
          bottomNavigationBar: TeslaBottomNav(
            onTap: (index) {
              if (index == 1)
                ...
                _batteryController.reverse(from: 0.85);
